            ...
            <div className="container pt-main">
                <div className="row align-items-start justify-content-around">
                    <div className="col-8">
                        ...
                        {/* Flexbox container for BlogDetailImg and commentSection */}
                        <div className="d-flex blog-img-comment-section align-items-start justify-content-between">
                            <div className="BlogDetailImg">
                                <img src={keyboard} alt="Blog detail" className="img-fluid" />
                            </div>
                            ...
                            <div className="commentSection">
                                ...
                                <div className="d-grid col-3 ml-auto blog-button margarine-regular mt-3">
                                    <button className="btn btn-dark" type="button">Comment</button>
                                </div>
                            </div>
                        </div>
